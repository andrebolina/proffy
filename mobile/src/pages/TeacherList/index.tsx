...
function TeacherList() {
    ...
    function loadFavorites() {
        AsyncStorage.getItem('Favorites').then(response => {
            if (response) {
                ...
                const favoritedClassesId = favoritedClasses.map((favoritedClass: ClassItemProps) => {
                    return favoritedClass.id;
                });

                setFavorites(favoritedClassesId);
            }
        });
    }
    ...
    return (
        <View style={styles.container}>
            ...
            >
                {classes.map((classInfo: ClassItemProps) => {
                    return (
                        <TeacherItem
                            key={classInfo.id}
                            classInfo={classInfo}
